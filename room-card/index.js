...
class IrnmnRoomCard extends HTMLElement {
    ...
    renderSlider() {
        return `
            <irnmn-slider class="room-card__slider" selectors='{
                ...
                <div class="room-card__slider-container" aria-polite="true" aria-label="Room images">
                    ${this.images
                        .map((img) => {
                ...
                ${
                    this.link360
                        ? `
                    <a href="${this.link360}" target="_blank" class="room-card__slider-360" aria-label="View 360 tour of ${this.title || 'this room'}" rel="noopener noreferrer">
    ...
    renderPricing() {
        ...
        <div class="room-card__pricing">
            <button class="room-card__pricing-cta btn --book-button" aria-label="Book ${this.title || 'this room'}">${this.labels.book || 'BOOK'}</button>
        </div>
        `;
    }
