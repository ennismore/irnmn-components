...
| Variable                                  | Fallback Variable              | Default                        | Description                        |
| ----------------------------------------- | ----------------------------- | ------------------------------ | ---------------------------------- |
...
| `--room-card-slider-button-hover-bg`      |                               | `rgba(0, 0, 0, 0)`             | Slider nav button hover background |
| `--room-card-slider-button-hover-color`   |                               | `#ffffff`                      | Slider nav button hover color      |
...
| `--room-card-slider-indicator-color`      |                               | `#ffffff`                      | Indicator dot color                |
...
| `--room-card-slider-360-pos-top`          | `--space-3`                   | `16px`                         | 360° link bottom offset            |
| `--room-card-slider-360-color`            |                               | `#ffffff`                      | 360° link text color               |
| `--room-card-slider-360-bg`               |                               | `rgba(0, 0, 0, .3)`            | 360° link background               |
| `--room-card-slider-360-font-size`        |                               | `0.875rem`                     | 360° link font size                |
| `--room-card-slider-360-padding`          |                               | `4px 8px`                      | 360° link padding                  |
| `--room-card-slider-360-radius`           |                               | `4px`                          | 360° link border radius            |
| `--room-card-slider-360-hover-color`      |                               | `#ffffff`                      | 360° link hover color              |
| `--room-card-slider-360-hover-bg`         |                               | `rgba(0, 0, 0, 6)`             | 360° link hover background         |
| `--room-card-slider-360-icon-size`        |                               | `24px`                         | 360° icon size                     |
| `--room-card-content-padding`             |                               | `16px 8px`                     | Content area padding               |
| `--room-card-content-font-size`           |                               | `0.875rem`                     | Content font size                  |
| `--room-card-content-gap`                 |                               | `8px`                          | Gap between content blocks         |
| `--room-card-title-font-size`             |                               | `1.125rem`                     | Title font size                    |
| `--room-card-title-font-family`           |                               | `Arial, sans-serif`            | Title font family                  |
| `--room-card-title-font-weight`           |                               | `bold`                         | Title font weight                  |
| `--room-card-title-color`                 |                               | `#000`                         | Title color                        |
| `--room-card-title-padding`               |                               | `0`                            | Title padding                      |
| `--room-card-description-font-size`       |                               | `0.875rem`                     | Description font size              |
| `--room-card-description-color`           |                               | `#000`                         | Description color                  |
...
| `--room-card-extras-button-radius`        |                               | `4px`                          | Extras button border radius        |
| `--room-card-extras-hover-color`          |                               | `#000`                         | Extras hover color                 |
...
| `--room-card-amenities-color`             |                               | `#000`                         | Amenities text color               |
| `--room-card-amenities-font-size`         |                               | `0.875rem`                     | Amenities font size                |
